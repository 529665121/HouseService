...
<br/>
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    <tr align="center" class="tdtitle">
      <th nowrap align="center" width="5%">序号</th>
   
      <th width="14%" align="center" nowrap id="employername" >客户名称</th>
      <th width="10%" height="24" align="center" nowrap id="pay" ><div align="center" orderBy="true"><strong>介绍费</strong></div></th>
      <th width="11%" height="24" align="center" nowrap id="tradedate" ><div align="center" orderBy="true"><strong>成交日期</strong></div></th>
      <th width="12%" align="center" nowrap id="workername" ><div align="center" orderBy="true"><strong>工人</strong></div></th>
      <th width="21%" align="center" nowrap id="company" ><strong>所属公司</strong></th>
      <th width="14%" align="center" nowrap id="queryorder" ><strong>操作</strong></th>
    </tr>
    ...
    <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
      ...
      <td align="center" nowrap><a href="../../../controller/orderservlet?reqType=queryorders">查看订单</a></td>
      <%--../ywgl/ddgl_xg.htm--%>
    </tr>
    </c:forEach>
  <!--  <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
