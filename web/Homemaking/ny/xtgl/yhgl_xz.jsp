    ...
    <table width="96%" height="97" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3"
        ...
        <tr>
            ...
            <td width="296" bgcolor="#FFFFFF">
                <input name="accountcode" type="text" id="textarea" value="" size="30" class="pi">
            </td>
            <td width="84" align="right" bgcolor="#FFFFFF">姓名</td>
            <td width="317" bgcolor="#FFFFFF">
                <input name="username" type="text" id="textarea4" value="" size="30" class="pi">
            </td>
        </tr>
        <tr>
            <td align="right" bgcolor="#FFFFFF">邮箱</td>
            <td bgcolor="#FFFFFF">
                <input name="email" type="text" id="textarea1" value="" size="30" class="pi">
            </td>
