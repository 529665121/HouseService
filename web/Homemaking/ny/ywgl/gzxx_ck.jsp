...
<br>
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    <tr>
      ...
      <td width="15%" bgcolor="#FFFFFF">${sessionScope.queryCustomer.employer_name}</td>
      <td width="10%" align="right" bgcolor="#FFFFFF">性别：</td>
      <td width="17%" bgcolor="#FFFFFF">
        ${sessionScope.queryCustomer.gender}     </td>
      <td width="10%" align="right" bgcolor="#FFFFFF">年龄：</td>
      <td width="13%" bgcolor="#FFFFFF">${sessionScope.queryCustomer.age}</td>
      <td width="10%" align="right" bgcolor="#FFFFFF">民族：</td>
      <td width="15%" bgcolor="#FFFFFF">${sessionScope.queryCustomer.nation}</td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF">籍贯：</td>
      <td bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.hometown}</td>
      <td align="right" bgcolor="#FFFFFF">学历：</td>
      <td bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.education}</td>
      <td align="right" bgcolor="#FFFFFF">身份证号码：</td>
      <td colspan="3" bgcolor="#FFFFFF">${sessionScope.queryCustomer.idnumber}</td>
    </tr>
    <tr>
      <td align="right" nowrap bgcolor="#FFFFFF">工作单位：</td>
      <td colspan="5" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.worker_unit}</td>
      <td align="right" bgcolor="#FFFFFF">职业：</td>
      <td bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.profession}</td>
    </tr>
    <tr>
      <td align="right" nowrap bgcolor="#FFFFFF">合同号：</td>
      <td colspan="5" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.contract}</td>
      <td align="right" bgcolor="#FFFFFF">合同期限：</td>
      <td bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.period}</td>
    </tr>
    <tr>
      <td align="right" nowrap bgcolor="#FFFFFF">联系电话：</td>
      <td align="center" bgcolor="#FFFFFF">手机</td>
      <td colspan="4" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.telephone}</td>
      <td align="right" bgcolor="#FFFFFF">住宅：</td>
      <td bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.house}</td>
    </tr>
    <tr>
      <td align="right" nowrap bgcolor="#FFFFFF">户口所在地：</td>
      <td colspan="7" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.address}</td>
    </tr>
    <tr>
      <td colspan="2" align="right" bgcolor="#FFFFFF">服务处所（地址）：</td>
      <td colspan="6" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.service_address}</td>
    </tr>
    <tr>
      ...
      <td colspan="6" align="left" bgcolor="#FFFFFF">${sessionScope.queryCustomer.home_current_address}</td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF">家庭人数：</td>
      <td colspan="6" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.home_people_number}</td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF">服务内容：</td>
      <td colspan="6" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.home_service}</td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF">房屋面积：</td>
      <td colspan="6" bgcolor="#FFFFFF">${sessionScope.queryCustomer.home_size}</td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF">饮食习惯：</td>
      <td colspan="6" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.home_food}</td>
    </tr>
    <tr>
      <td align="right" bgcolor="#FFFFFF">其他：</td>
      <td colspan="6" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.home_other}</td>
    </tr>
    <tr>
      <td align="center" nowrap bgcolor="#FFFFFF">要求服务等级：</td>
      <td colspan="7" align="left" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.claim}</td>
    </tr>
    <tr>
      <td align="right" nowrap bgcolor="#FFFFFF">经办人：</td>
      <td colspan="7" align="left" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.manager}</td>
    </tr>
    <tr>
      <td align="right" nowrap bgcolor="#FFFFFF">登记日期：</td>
      <td colspan="7" align="left" bgcolor="#FFFFFF">&nbsp;${sessionScope.queryCustomer.check_in_time}</td>
    </tr>
  </table>
